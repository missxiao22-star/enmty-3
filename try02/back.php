	...
	<div id="all">
		...
		<div id="mm">
			<div class="hal" id="lef">
				<a class="blo" href="?do=po" value="">分類網誌</a>
				<a class="blo" href="?do=news" value="">最新文章</a>
				<a class="blo" href="?do=pop" value="">人氣文章</a>
				<a class="blo" href="?do=know" value="">講座訊息</a>
				<a class="blo" href="?do=que" value="">問卷調查</a>
			</div>
